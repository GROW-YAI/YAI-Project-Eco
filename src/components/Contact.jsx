          ...
          <div className="flex flex-col lg:flex-row gap-12">
                ...
                <div className="flex gap-4">
                  <div className="flex-1">
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg font-['Playfair_Display'] bg-white border border-gray-300 focus:border-[#00A4AC] focus:ring-2 focus:ring-[#00A4AC]/20"
                      required
                    />
                  </div>
                  <div className="flex-1">
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-left text-xl font-['Playfair_Display'] font-semibold text-gray-900">
                    Location
                  </h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-left text-gray-600">ikedianfash@gmail.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-left text-gray-600">+233 24 453 0571</p>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            <div className="col-span-1">
              <div className="space-y-5">
                ...
                <p className="text-left text-white/90">
                  We practicalize innovation by creating stylish, eco-friendly fashion from recycled materials. We turn waste into wearable art.
                </p>
            ...
            <div className="col-span-1">
              <div className="space-y-5">
                ...
                <div className="space-y-3">
                  <div>
                    <div className="text-left font-bold">Address:</div>
                    <p className="text-left text-white/90">Ejura, Ashanti Region - Ghana</p>
                  </div>
                  <div>
                    <div className="text-left font-bold">Phone:</div>
                    <p className="text-left text-white/90">
                      <a href="tel:+233244530571" className="hover:text-white transition-colors duration-300">+233 24 453 0571</a>
                    </p>
                  </div>
                  <div>
                    <div className="text-left font-bold">Email:</div>
                    <p className="text-left text-white/90">
                      <a href="mailto:ikedianfash@gmail.com" className="hover:text-white transition-colors duration-300">ikedianfash@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
